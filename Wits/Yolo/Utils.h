...
#define ABOUTUS_TEXT @"About Us"

#define HOME_BTN_1 @"الصفحة الرئسية"
#define ABOUTUS_TEXT_1 @"عنا"
...
#define BETTER_LUCK @"Better Luck Next Time."
...
#define BETTER_LUCK_1 @"حظ أوفر في المرة القادمة"
...
#define BETTER_LUCK_2 @"Meilleure chance la prochaine fois"
...
#define BETTER_LUCK_3 @"Más suerte la próxima vez"
...
#define BETTER_LUCK_4 @"Mais Sorte da Próxima Vez"
